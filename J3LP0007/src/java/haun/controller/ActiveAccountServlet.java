...
public class ActiveAccountServlet extends HttpServlet {
    private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(ActiveAccountServlet.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logger.error("ActiveAccountServlet_Naming " + ex.getMessage());
        } catch (SQLException ex) {
            logger.error("ActiveAccountServlet_SQL " + ex.getMessage());
        } finally {
